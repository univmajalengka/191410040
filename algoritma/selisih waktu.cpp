...
int main()
{
	...
	if((keluar.detik-masuk.detik)<0){
		selisih.detik=(60+keluar.detik)-masuk.detik;keluar.menit;
	}
	else{
		selisih.detik=keluar.detik-masuk.detik;keluar.menit;
	}
	...
	cout<<"Perbedaan Jam Pertama dengan Jam Kedua adalah ="<<":"<<selisih.menit<<":"<<selisih.detik<<endl;
